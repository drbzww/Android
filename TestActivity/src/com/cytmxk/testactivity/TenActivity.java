...
public class TenActivity extends Activity {
	...
	private Button mGoToElevenButton = null;
	...
	private void initViews() {
		...
		mGoToElevenButton = (Button) findViewById(R.id.go_to_eleven_activity);
		...
		mGoToElevenButton.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(TenActivity.this,ElevenActivity.class);
