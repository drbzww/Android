...
public class SecondActivity extends Activity {
	...
	private Button mGoToThreeButton = null;
	...
	private void initViews() {
		...
		mGoToThreeButton = (Button) findViewById(R.id.go_to_three_activity);
		...
		mGoToThreeButton.setOnClickListener(new View.OnClickListener() {
