...
public class SevenActivity extends Activity {
	...
	private Button mGoToSixButton = null;
	...
	private void initViews() {
		...
		mGoToSixButton = (Button) findViewById(R.id.go_to_six_activity);
		...
		mGoToSixButton.setOnClickListener(new View.OnClickListener() {
