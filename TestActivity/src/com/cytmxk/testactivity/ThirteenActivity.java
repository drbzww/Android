...
public class ThirteenActivity extends Activity {
	...
	private Button mGoToSelfButton = null;
	...
	private void initViews() {
		...
		mGoToSelfButton = (Button) findViewById(R.id.go_to_self);
		...
		mGoToSelfButton.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(ThirteenActivity.this,ThirteenActivity.class);
