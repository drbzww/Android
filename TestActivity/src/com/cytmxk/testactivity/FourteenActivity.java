...
public class FourteenActivity extends Activity {
	...
	private Button mGoToFifteenButton = null;
	...
	private void initViews() {
		...
		mGoToFifteenButton = (Button) findViewById(R.id.go_to_fifteen_activity);
		...
		mGoToFifteenButton.setOnClickListener(new View.OnClickListener() {
