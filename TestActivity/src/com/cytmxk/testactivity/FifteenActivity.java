...
public class FifteenActivity extends Activity {
	...
	private Button mGoToFourteenButton = null;
	...
	private void initViews() {
		...
		mGoToFourteenButton = (Button) findViewById(R.id.go_to_fourteen_activity);
		...
		mGoToFourteenButton.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(FifteenActivity.this,FourteenActivity.class);
